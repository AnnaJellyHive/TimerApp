...
export default function TimerScreen({ route, navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text testID="timerModeLabel" accessible={true} accessibilityLabel="timerModeLabel" style={styles.modeLabel}>{modeLabel}</Text>

      <Text testID="timerTaskName" accessible={true} accessibilityLabel="timerTaskName" style={styles.taskName} numberOfLines={2}>
        {isBreak && nextSubtask ? `Nästa: ${nextSubtask}` : subtasks[currentIndex]}
      </Text>

      <Text testID="timerProgress" accessible={true} accessibilityLabel="timerProgress" style={styles.progress}>
